...
**ConnectShare** is a high-performance, lightweight, and gorgeous P2P desktop application designed for sharing files and clipboard contents between your computers on the local network. It is built using **Tauri v2** (Rust backend) and **React + TypeScript + Tailwind CSS v4** (frontend).
...
Before setting up ConnectShare, ensure you have the following installed on your computers:
...
## 📖 How to Use ConnectShare

1. **Open the App on Both Computers**: Start ConnectShare on both systems.
...
4. **Test the Connection**:
   ...
   * ConnectShare will ping the other system. If Computer B is running the app, its status indicator will pulse **green (Active)**.
5. **Start Sharing**:
   * Select the active peer in the sidebar.
   * **Files**: Drag any file from your computer and drop it directly onto the **Share File** dashed area. ConnectShare will stream it chunk-by-chunk with a live progress bar.
